...
import {debounce} from '../../../butterfly/debounce'
import normalizeVector2 from '../../../butterfly/normalizeVector2';
...
export default function butterflyinit() {
  const resolution = {
    x: 0,
    y: 0
  };
  ...
  const init = () => {
    ...
    loader.load('/public/texture/butterfly/tex.png', (texture) => {
