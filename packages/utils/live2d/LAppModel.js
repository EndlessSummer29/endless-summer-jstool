...
//============================================================
//============================================================
import {L2DBaseModel,L2DEyeBlink} from './framework/Live2DFramework'
            ...
            for (var i = 0; i < thisRef.modelSetting.getTextureNum(); i++)
            {
                ...
                thisRef.loadTexture(i, texPaths, function() {
                    ...
                    if( thisRef.isTexLoaded ) {
                        ...
                        {
                            console.log('加载物理:thisRef.modelHomeDir',thisRef.modelHomeDir)
                            console.log('加载物理:thisRef.modelSetting.getPhysicsFile()',thisRef.modelSetting.getPhysicsFile())
